        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="https://wa.me/2347065599931?text=Hi%20Elite%20Care%2C%20I%20want%20to%20shop%20for%20medical%20equipment." target="_blank" rel="noopener noreferrer" className="flex items-start gap-2.5 text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors" data-testid="link-footer-whatsapp">
