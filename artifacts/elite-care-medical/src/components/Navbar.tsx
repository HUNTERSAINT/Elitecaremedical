      ...
      <div className="bg-primary text-primary-foreground py-1.5 px-4 text-xs">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <a href="https://wa.me/2347065599931?text=Hi%20Elite%20Care%2C%20I%20want%20to%20shop%20for%20medical%20equipment." target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:opacity-80 transition-opacity" data-testid="link-whatsapp-topbar">
              <Phone size={12} />
